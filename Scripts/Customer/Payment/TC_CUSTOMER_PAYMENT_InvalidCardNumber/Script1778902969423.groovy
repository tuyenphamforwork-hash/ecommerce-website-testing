...
// ========================================
// Fill INVALID Card Information
// ========================================
// INVALID CARD NUMBER
WebUI.setText(findTestObject('CUSTOMER/Payment_Stripe/txtbox_cardNumber'), '1234567890123456')
...
// ========================================
// Still on Stripe page
WebUI.verifyElementPresent(findTestObject('CUSTOMER/Payment_Stripe/div_payment_stripe'), 10)

// Pay button still displayed
WebUI.verifyElementPresent(findTestObject('CUSTOMER/Payment_Stripe/btn_Pay'), 10)

WebUI.verifyElementPresent(findTestObject('CUSTOMER/Payment_Stripe/msg_InvalidCardNumber'), 0)

// ========================================
// Verify error message displayed
// ========================================
// Stripe commonly shows:
// "Your card number is invalid."
boolean invalidCardErrorDisplayed = WebUI.verifyTextPresent('Your card number is invalid.', false, FailureHandling.OPTIONAL)

WebUI.verifyEqual(invalidCardErrorDisplayed, true)
