...
// ========================================
// TC_CUSTOMER_CHECKOUT_InvalidPhone
// ========================================
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('CUSTOMER/Checkout_Page/txtbox_lastName'), '')
...
// INVALID PHONE
WebUI.setText(findTestObject('CUSTOMER/Checkout_Page/txtbox_contactNumber'), '123abc')
