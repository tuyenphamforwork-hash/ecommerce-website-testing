...
WebUI.comment("🚀 START TC_ADMIN_ADD_PRODUCT_EMPTY_IMAGE")
...
// =========================
// STEP 5: TEST DATA (VALID EXCEPT IMAGE)
// =========================
...
// =========================
// STEP 6: DO NOT UPLOAD IMAGE ❌
// =========================
WebUI.comment("⚠️ IMAGE NOT UPLOADED FOR VALIDATION TEST")
