...
WebUI.comment("🚀 START TC_ADMIN_ADD_PRODUCT_SUCCESS")
...
WebUI.verifyTextPresent(productName, false, FailureHandling.STOP_ON_FAILURE)

WebUI.comment("✅ PRODUCT CREATED SUCCESSFULLY: " + productName)
