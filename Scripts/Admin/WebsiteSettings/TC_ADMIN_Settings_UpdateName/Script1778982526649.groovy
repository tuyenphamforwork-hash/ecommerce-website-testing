...
String newWebsiteName = 'New E-Commerce'

WebUI.setText(findTestObject('ADMIN/SettingsPage/input_website_name'), newWebsiteName)
...
WebUI.verifyElementPresent(findTestObject('ADMIN/SettingsPage/input_website_name_updated'), 0)
