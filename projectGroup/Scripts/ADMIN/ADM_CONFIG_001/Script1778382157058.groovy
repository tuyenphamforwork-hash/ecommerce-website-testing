...
WebUI.click(findTestObject('Page_Admin-Panel/a_Setting'))

WebUI.uploadFile(
    findTestObject('Page_Admin-Panel/input_logo'),
    'D:\\001_SoftWare_Storage\\Xampp\\htdocs\\testing-ecommerce-website\\images\\blog\\blog-4.jpg'
)
