...
WebUI.click(findTestObject('Page_HCA E-Commerce/ul_Home'))
...
WebUI.setEncryptedText(findTestObject('Page_ADMIN  Login/input_Password'), 'p3dxp9GiIFjSrCRSlvSLjA==')
...
WebUI.click(findTestObject('Page_Admin-Panel/h6_Users'))
