...
WebUI.click(findTestObject('Page_Admin-Panel/a_ADD Products'))

WebUI.setText(findTestObject('Page_Admin-Panel/input_Product Name'), 'Uniglo T-shirt')

WebUI.setText(findTestObject('Page_Admin-Panel/input_prod-price'), '30')

WebUI.setText(findTestObject('Page_Admin-Panel/input_prod-discount'), '10')

WebUI.setText(findTestObject('Page_Admin-Panel/textarea_prod-desc'), 'The Uniqlo cotton T-shirt ')

WebUI.setText(findTestObject('Page_Admin-Panel/input_noofitem'), '123')

WebUI.click(findTestObject('Page_Admin-Panel/label_Available'))

WebUI.uploadFile(
    findTestObject('Page_Admin-Panel/input_prod-img'),
    'D:\\001_SoftWare_Storage\\Xampp\\htdocs\\testing-ecommerce-website\\images\\uniqlo.jpg'
)

WebUI.click(findTestObject('Page_Admin-Panel/button_submit'))
