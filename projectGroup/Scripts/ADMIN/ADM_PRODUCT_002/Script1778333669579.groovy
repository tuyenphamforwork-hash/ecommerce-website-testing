...
WebUI.setText(findTestObject('Page_Admin-Panel/input_Product Name'), 'Levis T-shirt')

WebUI.setText(findTestObject('Page_Admin-Panel/input_prod-price'), '50')

WebUI.setText(findTestObject('Page_Admin-Panel/textarea_prod-desc'), 'the lastest Levis cotton T-shirt')

WebUI.setText(findTestObject('Page_Admin-Panel/input_noofitem'), '1233')
