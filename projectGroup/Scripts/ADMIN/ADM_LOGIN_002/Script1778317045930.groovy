...
WebUI.navigateToUrl('http://localhost:9999/testing-ecommerce-website/index.php?id=unknown')
...
WebUI.setEncryptedText(findTestObject('Page_Login(USER)/input_Password'), 'nwr9I1qT+J0GbQ++JlYjHw==')
